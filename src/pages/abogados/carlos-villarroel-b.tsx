...
export default function CarlosVillarroel() {
      ...
      <Grid container spacing={3} alignItems={{  md: 'space-between' }} sx={{ minHeight: '500px' }}>
        {mdUp && (
          <Grid xs={12} md={6} lg={4}>
            <Image alt="about" src="/assets/team/villaroel.jpg" sx={{ borderRadius: 2, width: '420px', height: '500px' }} />
          </Grid>
        )}
        <Grid xs={12} md={6} lg={8} sx={{ pl: { lg: 11 } }}>
          ...
          {currentTab === 'Educación' && (
            <Typography variant="body1" sx={{color: 'text.primary', pt: 2}}>
              ...
              Premios y reconocimientos: Premio Tocornal y Premio Montenegro al alumno más sobresaliente de su generación (1980); Premio “Excelencia Académica” al mejor profesor de su categoría (2008), otorgados por la Facultad de Derecho de la Pontificia Universidad Católica de Chile.
            </Typography>
          )}
          ...
          {currentTab === 'Actividad Académica' && (
            <>
              <Typography variant="body1" sx={{color: 'text.primary',  pt: 2}}>
                Profesor de Derecho Internacional Privado, Facultad de Derecho, Pontificia Universidad Católica de Chile (1984 a la fecha). Ex miembro del Consejo de la Facultad de Derecho de la Pontificia Universidad Católica de Chile.
                <br/><br/>
          ...
          {currentTab === 'Publicaciones' && (
            <>
              ...
              <Typography variant="body1" sx={{color: 'text.primary', fontFamily: primaryFont, pt: 2}}>
                Autor de varias publicaciones, entre ellas los siguientes libros: "La obligación natural como elemento moralizador de la relación jurídica en el Código Civil Chileno" (1982), obra que la Facultad de Derecho de la Pontifica Universidad Católica de Chile distinguió con el Premio Pedro Lira Urquieta; "Curso de Derecho Internacional Privado. Parte General" (2004); "Derecho Internacional Privado" (2016).
                Idiomas: Español, inglés y francés.Education: Pontificia Universidad Católica de Chile School of Law (Bachelor of Laws, 1981).
